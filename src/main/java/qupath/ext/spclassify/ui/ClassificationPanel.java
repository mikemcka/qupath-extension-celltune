...
import qupath.ext.spclassify.SpClassifyExtension;
import qupath.ext.spclassify.classifier.DataPoolingService;
import qupath.ext.spclassify.classifier.DualModelClassifier;
import qupath.ext.spclassify.classifier.FeaturePruner;
import qupath.ext.spclassify.classifier.HyperparameterTuner;
...
import qupath.ext.spclassify.io.TrainingLogRecorder;
import qupath.ext.spclassify.model.*;
 ...
 * central hub for the entire SP Classify workflow.
 */
public class ClassificationPanel extends VBox {
    ...
    public ClassificationPanel(QuPathGUI qupath) {
        ...
        Spinner<Integer> cpuThreadsSpinner = new Spinner<>(
                ...
                SpClassifyExtension.trainingThreadsProperty().get());
        ...
        cpuThreadsSpinner
                .valueProperty()
                .addListener((v, o, n) ->
                        SpClassifyExtension.trainingThreadsProperty().set(n == null ? 0 : n));
    ...
    // ── State setters (called by SpClassifyExtension to share state) ──
    ...
    private void doTrain() {
        ...
        progressStage.setTitle("SP Classify \u2014 Training");
                        ...
                        if (projectRef != null) {
                            ...
                            if (scope == null) {
                                ...
                                try {
                                    ...
                                    System.err.println(
                                            "[SP Classify] Failed to persist training metrics: " + ex.getMessage());
                                }
                            }
